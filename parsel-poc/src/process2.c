...
int main(int argc, char **argv) {
    ...
    printf("P2: Received %lu as argument 1\n", ep);
    printf("P2: Received %lu as argument 2\n", ep_ap);
    ...
    printf("P2: Some random stuff = %f, %f\n", mean, stdDev);

    printf("P2: Minding my own business! \n");
    while(1);

		printf("P2: time to die! \n");
		return 0;
